<template>
    <div>
        ...
        <div class="px-6 md:px-16 lg:px-24 py-6">
            ...
            <p class="text-base xl:text-lg">- <router-link class="text-base xl:text-lg no-underline hover:underline" to="surfing">Windsurfkurse belegen und Surfmaterial ausleihen</router-link></p>
            <p class="text-base xl:text-lg">- <router-link class="text-base xl:text-lg no-underline hover:underline" to="sup">Stand Up Paddling Boards leihen und an SUP Touren teilnehmen</router-link></p>
            <p class="text-base xl:text-lg">- <router-link class="text-base xl:text-lg no-underline hover:underline" to="sailing">Segeln lernen und Jollen leihen</router-link></p>
        </div>

        <div class="flex items-start">
            <img class="w-1/3" src="../assets/start/thumbs/start01.jpg"/>
            <img class="w-1/3" src="../assets/start/thumbs/start02.jpg"/>
        ...
        <div class="px-6 md:px-16 lg:px-24 py-6">
            ...
            <p class="pb-6 text-base xl:text-lg">
                ...
                Wir, die Surfschule am Großen Meer, freuen uns auf euren Besuch!
            </p>
        </div>

        <div class="flex items-start">
            <img class="w-1/3" src="../assets/start/thumbs/meer01.jpg"/>
            <img class="w-1/3" src="../assets/start/thumbs/meer02.jpg"/>
        ...
        <div class="px-6 md:px-16 lg:px-24 py-6">
            ...
            <p class="pb-6 text-base xl:text-lg">
                ...
                Sonnenbrillen, Surferschmuck, uvm. Neben dem Verleih von Surfmaterial bieten wir auch die Lagerung des
                eigenen Surfmaterials direkt an der Surfschule an.
            </p>
        </div>

        <div class="flex items-start">
            <img class="w-1/3" src="../assets/start/thumbs/shop04.jpg"/>
            <img class="w-1/3" src="../assets/start/thumbs/shop03.jpg"/>
            <img class="w-1/3" src="../assets/start/thumbs/shop05.jpg"/>
        </div>
