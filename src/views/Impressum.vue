<template>
    <div>
        ...
        <div class="px-8 md:px-16 lg:px-24 py-6">
            ...
            <div class="pb-6">
                <div class="flex">
                    <p class="w-64 flex-no-shrink">Jens Radde</p>
                    <div class="flex-grow">
                        <p>Surfschule Grosses Meer</p>
                        <p>Forlitzer Str. 213</p>
                        <p>26624 Forlitz-Blaukirchen / Südbrookmerland</p>
                    </div>
                </div>
                <div class="flex">
                    <p class="w-64 flex-no-shrink">Telefon</p>
                    <p class="flex-grow">04942 5096</p>
                </div>
                <div class="flex">
                    <p class="w-64 flex-no-shrink">Mobil</p>
                    <p class="flex-grow">0177 8879184</p>
                </div>
                <div class="flex">
                    <p class="w-64 flex-no-shrink">E-Mail</p>
                    <p class="flex-grow">info@grosses-meer.surf</p>
                </div>
                <div class="flex">
                    <p class="w-64 flex-no-shrink">Umsatzsteuer-ID</p>
                    <p class="flex-grow">54/135/01788</p>
                </div>
            </div>
        </div>
        ...
        <div class="px-8 md:px-16 lg:px-24 py-6">
            ...
            <h1 class="pt-8">DISCLAIMER – RECHTLICHE HINWEISE
            </h1>
            <div class="w-24 my-4 border-grey-light border-b"></div>
            ...
            <p class="pb-6">
                ...
                als solche gekennzeichnet. Die unerlaubte Vervielfältigung oder Weitergabe einzelner Inhalte oder kompletter
        ...
        <div class="px-8 md:px-16 lg:px-24 py-6">
            ...
            <h1 class="pt-8">DATENSCHUTZERKLÄRUNG</h1>
            <div class="w-24 my-4 border-grey-light border-b"></div>
