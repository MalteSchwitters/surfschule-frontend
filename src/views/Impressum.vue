    ...
    <div class="">
        ...
        <div class="p-2">
            <div class="px-6 md:px-16 lg:px-24 py-4 rounded mb-2 bg-white shadow xl:shadow-none">
                ...
                <h1 class="pt-8 text-xl sm:text-3xl">Datenschutz</h1>
                <div class="w-24 my-4 border-grey-light border-b"></div>
                <h2 class="text-base sm:text-lg xl:text-xl py-4">Datenschutzerklärung für das Facebook-Plugin („Gefällt
                    mir“)</h2>
                <p class="pb-6 text-sm sm:text-base xl:text-lg">
                    Diese Webseite nutzt Plugins des Anbieters Facebook.com, welche durch das Unternehmen Facebook Inc.,
                    1601 S. California Avenue, Palo Alto, CA 94304 in den USA bereitgestellt werden. Nutzer unserer
                    Webseite,
                    auf der das Facebook-Plugin („Gefällt mir“-Button) installiert ist, werden hiermit darauf
                    hingewiesen,
                ...
                <p class="pb-6 text-sm sm:text-base xl:text-lg">
                    ...
                    Informationen
                    über Ihre Webseitenbesuche auf unserer Homepage enthalten. Dies hat für eingeloggte Facebook-Nutzer
                    zur
                ...
                <p class="pb-6 text-sm sm:text-base xl:text-lg">
                    Quelle: <a class="text-sm sm:text-base xl:text-lg no-underline hover:underline"
                               href="https://www.juraforum.de/" target="_blank">www.juraforum.de</a>
                </p>
            </div>
        </div>
    </div>
