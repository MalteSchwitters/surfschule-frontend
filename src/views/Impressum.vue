    ...
    <div class="">
        ...
        <div class="p-2">
            <div class="px-6 md:px-16 lg:px-24 py-4 rounded mb-2 bg-white shadow xl:shadow-none">
                ...
                <h1 class="pt-8 text-2xl xl:text-3xl">Disclaimer – Rechtliche Hinweise</h1>
                <div class="w-24 my-4 border-grey-light border-b"></div>
                <h2 class="py-4">§ 1 Warnhinweise zu Inhalten</h2>
                ...
                <p class="text-base xl:text-lg">
                    Quelle: Impressumsgenerator von <a class="no-underline hover:underline" href="https://www.juraforum.de/" target="_blank">www.juraforum.de</a>
                </p>
            </div>
        </div>
        ...
        <div class="p-2">
            <div class="px-6 md:px-16 lg:px-24 py-4 rounded mb-2 bg-white shadow xl:shadow-none">
                ...
                <p class="pb-6 text-base xl:text-lg">
                    Quelle: <a class="no-underline hover:underline" href="https://www.juraforum.de/" target="_blank">www.juraforum.de</a>
                </p>
            </div>
        </div>
    </div>
